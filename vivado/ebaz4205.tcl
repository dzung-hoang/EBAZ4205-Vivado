...
#
# Generated by Vivado on Wed Oct 16 22:57:56 PDT 2024
...
#
#    "EBAZ4205-Vivado/vivado/ebaz4205/ebaz4205.srcs/sources_1/imports/hdl/open_drain.v"
#    "EBAZ4205-Vivado/vivado/ebaz4205/ebaz4205.srcs/constrs_1/imports/new/ebaz4205.xdc"
#
...
if { [get_files [list open_drain.v]] == "" } {
  import_files -quiet -fileset sources_1 EBAZ4205-Vivado/vivado/ebaz4205/ebaz4205.srcs/sources_1/imports/hdl/open_drain.v
}
...
# open_drain
  ...
  # Create instance: open_drain_0, and set properties
  set block_name open_drain
  set block_cell_name open_drain_0
  if { [catch {set open_drain_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $open_drain_0 eq "" } {
...
\
  ...
  connect_bd_net -net open_drain_0_ODout [get_bd_pins open_drain_0/ODout] [get_bd_ports LED]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins processing_system7_0/ENET0_GMII_RXD]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_ports enet0_gmii_txd]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins open_drain_0/Din]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list ebaz4205.bd]] ] == 1  } {
  ...
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list ebaz4205.bd]] -top]
